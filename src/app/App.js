...
import mugshot from '../images/normale-foto-van-mijn-hoofd.png';
...
function PausableSwitchingText() {
	...
	return (
		<span onClick={() => setPaused(!isPaused)} title="Click to pause">
...
export default function App() {
	...
	return (
		<>
			...
			>
				<Banner
					primaryButtons={bannerPrimaryButtons}
					secondaryButtons={bannerSecondaryButtons}
					subtitle={<PausableSwitchingText />}
					infoText={
						<>
							<p>
								Currently <abbr title="Product owner">PO</abbr> at{' '}
								<a
									href={'http://fontoxml.com'}
									target="_blank"
